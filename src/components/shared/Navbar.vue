...
<template>
  ...
  >
    ...
    <div class="flex gap-3">
      <button class="btn btn-accent font-sans text-sm text-white font-semibold">
        Iniciar sesión
      </button>
      <button class="btn btn-gradient btn-primary font-sans text-sm text-white font-semibold">
        Registrarse
      </button>
    </div>
  </nav>
